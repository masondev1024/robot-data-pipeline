...
> 13분 평가 (4분 발표 + 8:36 시연 + 30s Q&A). 한국어 발표.
...
## 🎬 시연 — 마커별 멘트 (총 516s ≈ 8:36, RECORDING_SCRIPT 정합)

> **시간 제약**: 13분 budget = 발표 4분 + 시연 8:36 + Q&A 30s. mason 자율 발화 + 청중 인지
> sweet spot 안에서 본론·라이브·운영자UX·V3 vision 한 영상에 압축.
>
> **budget 배분**: 마커 0 도입 **120s** (사이드바 3카드 deep dive + fleet + DAG + KPI 한번에),
> 마커 5 결함+**Operator View 전환** 65s, 마커 10 OEE+**V3 Enterprise Vision** 88s,
> 마커 4·7 각 38s (라이브 ATE / 4 Agent), 마커 8 (β slider 핵심) 45s,
> 마커 2·6 각 28s, 마커 1·3·9 각 22s.
>
> **녹화 기준 cumulative** (RECORDING_SCRIPT 와 1:1 동일):
> | M | 시작 | 종료 | 머무는 시간 | 강조 |
> |---|------|------|------|---|
...
> | **M5** | **3:50** | **4:55** | **65s** | 🚨 결함 + **Operator View 전환** |
> | M6 | 4:55 | 5:23 | 28s | |
> | M7 | 5:23 | 6:01 | 38s | ⭐ 4 Agent |
> | M8 | 6:01 | 6:46 | 45s | 🔑 β slider |
> | M9 | 6:46 | 7:08 | 22s | |
> | **M10** | **7:08** | **8:36** | **88s** | ⭐ OEE + 🚀 **V3 Vision + closing** |
...
**연습 우선순위 (D-1 리허설)**:
1. 5 slide 발표 **3분 50초 ± 10초** (slide 당 48s, 13분 budget 정합)
2. 시연 **8분 36초 ± 15초** (timer 옆에 두기, cumulative 표 + RECORDING_SCRIPT 기준)
